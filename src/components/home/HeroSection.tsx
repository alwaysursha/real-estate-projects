    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 h-screen flex flex-col justify-center items-center">
        ...
        <div className="w-full max-w-5xl mx-auto text-center mb-6 md:mb-12">
          ...
          <div className={`${playfair.className} text-sm sm:text-base md:text-xl lg:text-2xl text-white mx-auto tracking-normal md:tracking-wider overflow-x-auto whitespace-nowrap md:whitespace-normal px-2 md:px-4 pb-2 md:pb-0 hide-scrollbar`}>
            <span className="inline-block mx-1 md:mx-2 hover:text-yellow-400 transition-colors">DUBAI</span>
            <span className="inline-block mx-1 md:mx-2 text-yellow-400">•</span>
            <span className="inline-block mx-1 md:mx-2 hover:text-yellow-400 transition-colors">ABU DHABI</span>
            <span className="inline-block mx-1 md:mx-2 text-yellow-400">•</span>
            <span className="inline-block mx-1 md:mx-2 hover:text-yellow-400 transition-colors">SHARJAH</span>
            <span className="inline-block mx-1 md:mx-2 text-yellow-400">•</span>
            <span className="inline-block mx-1 md:mx-2 hover:text-yellow-400 transition-colors">AJMAN</span>
          </div>
        </div>
